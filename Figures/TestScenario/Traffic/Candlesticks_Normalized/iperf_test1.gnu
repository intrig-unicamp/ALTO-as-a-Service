...
set output "traffic_iperf_test1.eps"
plot 'iperf_test1.csv' using ($1-0.15):3:2:6:5 with candlesticks fs pattern 2 t "HopsNumber" lt 1 lw 3 lc rgb "green" whiskerbars, \
...
'' using ($1+0.15):8:7:11:10 with candlesticks fs pattern 5 t "HopsNumberPTT" lt 1 lw 3 lc rgb "green" whiskerbars, \
